...
fn Demo(cx: Scope) -> Element {
    render!{
        div {
            ...
            div {
                class: "w-3/4",
                h2 { class: "text-2xl md:text-6xl font-bold rounded-md", "Build AI powered workflows with ease" }
                div {
                    class: "m-4",
                    img {
...
fn Plugins(cx: Scope) -> Element {
    render! {
        div { class: "w-screen h-[75vw] flex flex-col justify-center items-center static",
            h2 {
                class: "bg-[#B95F62] text-2xl md:text-6xl font-bold text-center left-[calc(200vw-var(--scroll)*200vw)] w-screen rounded-t-md p-2",
                "Securely extend Floneum with plugins"
            }
            div {
                class: "-z-30 grid grid-cols-2 grid-rows-2 w-screen",
                div {
                    class: "bg-[#AACDCF] w-[50vw] h-[25vw] flex flex-col justify-center items-center  overflow-clip",
                    img {
                        class: "w-60",
                ...
                div {
                    class: "bg-[#283549] w-[50vw] h-[25vw] flex flex-col justify-center items-center overflow-clip lg:text-xl text-white p-2",
                    p {
                        class: "text-xl md:text-2xl p-2",
                ...
                div {
                    class: "bg-[#283549] w-[50vw] h-[25vw] flex flex-col justify-center items-center overflow-clip lg:text-xl text-white rounded-bl-md p-2",
                    p {
                        class: "text-xl md:text-2xl p-2",
                ...
                div {
                    class: "bg-[#AACDCF] w-[50vw] h-[25vw] flex flex-col justify-center items-center  overflow-clip text-white rounded-br-md",
...
fn Pitch(cx: Scope) -> Element {
    render!{
        div {
            ...
            div {
                class: "bg-[#B95F62] w-full h-full flex flex-col justify-end items-end text-white overflow-clip",
                h2 {
                    class: "text-xlg sm:text-4xl md:text-5xl lg:text-6xl font-bold p-8 w-1/2 text-right",
                    "Your Multi Tool for Language Tasks"
                }
            }
            div {
                class: "bg-[#283549] w-full h-full flex flex-col justify-start items-start -rotate-90 text-white overflow-clip",
                h2 {
                    class: "text-xlg sm:text-4xl md:text-5xl lg:text-6xl font-bold p-8 w-1/2 text-left",
                    "Build AI powered workflows visually"
                }
            }
            div {
                class: "bg-[#EFFBF8] w-full h-full flex flex-col justify-end items-end -rotate-90 overflow-clip",
                h2 {
                    class: "text-xlg sm:text-4xl md:text-5xl lg:text-6xl font-bold p-8 w-1/2 text-right",
            ...
            div {
                class: "bg-[#AACDCF] w-full h-full flex flex-col justify-start items-start overflow-clip",
                h2 {
                    class: "text-xlg sm:text-4xl md:text-5xl lg:text-6xl font-bold p-8 w-1/2 text-left",
